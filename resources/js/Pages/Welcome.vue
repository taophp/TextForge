...
<template>
    ...
    <div
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center text-gray-800 dark:text-gray-200 text-5xl font-serif">
                <div>
                    <span class="text-9xl inline-block">T</span><span class="relative -left-4">ext</span><span class="text-8xl inline-block relative -left-4">f</span><span class="relative -left-4">orge</span>
                </div>
            </div>
